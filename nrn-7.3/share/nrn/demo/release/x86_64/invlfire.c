...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IntervalFire /home/stephan/hg/nrn/nrn-7.3/share/nrn/demo/release/x86_64/invlfire.mod\n");
...
double firetime ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
   double _lfiretime;
