#
#	Neuron 7.3 and InterViews 17 spec file
#
...
%define configure_args   '--prefix=/Users/stephan/Code/git/neuron/nrn-7.3' '--without-iv' 'CXX=g++-mp-4.8' 'CC=gcc-mp-4.8'
...
Source: ftp://ftp.neuron.yale.edu/neuron/unix/nrn-7.3.tar.gz
